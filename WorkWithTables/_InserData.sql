...
(1,'Не подтверждена', 'text-bg-secondary'),
(2,'В рассмотрении', 'text-bg-secondary'),
(3,'Принята', 'text-bg-primary'),
(4,'Инспектор выехал', 'text-bg-light-info'),
(5,'Инспектор на месте', 'text-bg-light-info'),
(6,'Поездка', 'text-bg-light-info'),
(7,'Заявка закончена', 'text-bg-success'),
(8,'Выявление', 'text-bg-primary'),
(9,'Лист Ожидания', 'text-bg-warning'),
(10,'Отмена', 'text-bg-secondary'),
(11,'Отказ', 'text-bg-secondary'),
(12,'Пассажир опаздывает', 'text-bg-danger'),
(13,'Инспектор опаздывает', 'text-bg-danger');
